...
function wpb_custom_new_menu() {
    register_nav_menu('my-custom-menu',__( 'فهرست سایت' ));

    // اول از همه از تابع وردپرس برای ساخت منو استفاده میکنیم

    // بعد آیدی دلخواه به اون تابع میدیم که فهرست روبسازه

    // بعد اسم دلخواه رو به فهرست میدیم
  }
  add_action( 'init', 'wpb_custom_new_menu' );



  function custom_mehrnaz_menu() {
    register_nav_menu('custom_mehrnaz_menu',__( 'menu' ));

  }
  add_action( 'init', 'custom_mehrnaz_menu' );
// wp_nav_menu( array( 'theme_location' => 'bistscript-Nav', 'menu_class' => 'navbar' ) );
add_theme_support( 'post-formats',  array ( 'aside', 'gallery', 'quote', 'image', 'video' ) );
add_theme_support( 'responsive-embeds' );

/*=================== replywp.com code wordpress ================*/
